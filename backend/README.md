...
## Project Structure
    ...
    ├── crowdbotics_test_ap_43772  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_test_ap_43772`
...
2. Clone this repo and `cd crowdbotics_test_ap_43772`
